---
description: Lint only — consistency checks
argument-hint: [bundle]
---

Run `/llm-wiki-lint` exactly as AGENTS.md defines it.

1. Read `AGENTS.md` in full, unless you already have in this session.
2. Read `workflows/lint.md` in full before doing anything — the procedure lives there,
   not in this file.
