---
description: Ingest only — process new raw sources
argument-hint: [bundle]
---

Run `/llm-wiki-ingest` exactly as AGENTS.md defines it.

1. Read `AGENTS.md` in full, unless you already have in this session.
2. Read `workflows/ingest.md` in full before doing anything — the procedure lives there,
   not in this file.
