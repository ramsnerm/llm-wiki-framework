---
description: Switch default bundle permanently in the repo
argument-hint: <bundle>
---

Run `/llm-wiki-set-persistent-default-bundle` exactly as AGENTS.md defines it.

1. Read `AGENTS.md` in full, unless you already have in this session.
2. The procedure is short enough to live in AGENTS.md itself: follow
   the section "Switching the default bundle".
